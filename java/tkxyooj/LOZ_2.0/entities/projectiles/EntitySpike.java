/*
 * 
 * This class was created by <Mybysco> for the Cactus Mod.
 * Github source can be found here:
 * https://github.com/Mrbysco/ModJNam-Mod
 * 
 */
...
public class EntitySpike extends Entity implements IProjectile
{
    @SuppressWarnings("unchecked")
	private static final Predicate<Entity> SPIKE_TARGETS = Predicates.and(EntitySelectors.NOT_SPECTATING, EntitySelectors.IS_ALIVE, new Predicate<Entity>()
    {
    ...
    private static final DataParameter<Byte> CRITICAL = EntityDataManager.<Byte>createKey(EntitySpike.class, DataSerializers.BYTE);
    private int xTile;
    private int yTile;
    private int zTile;
    ...
    public static DamageSource causeSpikeDamage(EntitySpike spike, @Nullable Entity indirectEntityIn)
    {
        return (new EntityDamageSourceIndirect("spike", spike, indirectEntityIn)).setProjectile();
    }
    ...
    protected void onHit(RayTraceResult raytraceResultIn)
    {
        ...
        if (entity != null)
        {
            ...
            {
                damagesource = causeSpikeDamage(this, this.shootingEntity);
            }
            ...
            if (entity.attackEntityFrom(damagesource, (float)i))
            {
                if (entity instanceof EntityLivingBase)
                {
                    ...
                    this.spikeHit(entitylivingbase);
    ...
    protected void spikeHit(EntityLivingBase living)
    {
    }
    ...
    {
        Entity entity = null;
        List<Entity> list = this.world.getEntitiesInAABBexcluding(this, this.getEntityBoundingBox().expand(this.motionX, this.motionY, this.motionZ).grow(1.0D), SPIKE_TARGETS);
        double d0 = 0.0D;
    ...
    public void writeEntityToNBT(NBTTagCompound compound)
    {
        ...
        compound.setByte("shake", (byte)this.spikeShake);
