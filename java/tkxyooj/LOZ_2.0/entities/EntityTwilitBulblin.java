/*
 * Adpated from Daveyx0's Mod Primitive Mobs Skeleton Warrior class. 
 * Big feature is the ability to switch between range and melee attacks. 
 * This inculdes not just the mob class but the mob ai classes as well.
 */

package tkxyooj.LOZ.entities;

import tkxyooj.LOZ.entities.ai.*;
...
public class EntityTwilitBulblin extends EntitySkeleton {

	public EntityTwilitBulblin(World worldIn) {
		super(worldIn);
	}
