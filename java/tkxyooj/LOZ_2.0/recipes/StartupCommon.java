...
//    GameRegistry.register(saplingRecipe);
	...
	*/
	  ...
	  GameRegistry.addSmelting(tkxyooj.LOZ.items.StartupCommon.unfiredocarina, new ItemStack(tkxyooj.LOZ.items.StartupCommon.ocarinabase, 1), 0.7F);
  }
